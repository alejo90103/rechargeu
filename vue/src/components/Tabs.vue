                          ...
                          <div class="form-group col-md-12">
                            <div class="input-group-prepend row">
                              ...
                              <div class="col-md-10 material-select">
                                <multiselect v-model="choose_offer_cell" :searchable="false" :max-height=170 :placeholder="$t('dashboard.tabs.offer_placeholder')" :allowEmpty="false" label="name" track-by="name" :options="optionsCell" :show-labels="false">
                        ...
                        <div class="form-row">
                          ...
                          <div class="form-group col-md-12">
                            <div class="input-group-prepend row">
                              <div class="input-group-text col-md-2" style="color: #000; font-weight: 200; font-size: 25px; padding-left: 10px">€</div>
                              <div class="col-md-10 material-select">
                                <multiselect v-model="choose_offer_nauta" :searchable="false" :max-height=170 :placeholder="$t('dashboard.tabs.offer_placeholder')" :allowEmpty="false" label="name" track-by="name" :options="optionsNauta" :show-labels="false">
                                  <template slot="singleLabel" slot-scope="props">
                                    <div class="option__desc">
                                      <span class="option__title" style="font-size: 25px;">{{props.option.name}}</span>
                                      <br>
