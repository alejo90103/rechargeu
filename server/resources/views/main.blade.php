                  ...
                  <div class="kt-widget14__content">
                    ...
                    <div class="kt-widget14__legends">
                      <div class="kt-widget14__legend">
                        ...
                        <span class="kt-widget14__stats">Nauta</span>
                      </div>
                      <div class="kt-widget14__legend">
                        <span class="kt-widget14__bullet kt-bg-success"></span>
                        <span class="kt-widget14__stats">Móvil</span>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="kt-portlet kt-portlet--height-fluid">
                <div class="kt-widget14">
                  <div class="kt-widget14__header">
                      ...
                      <span class="kt-widget14__desc">
                        Cantidad de recargas por su estado
                      </span>
                    </div>
                  <div class="kt-widget14__content">
                    <div class="kt-widget14__chart">
                    ...
                    <div class="kt-widget14__legends">
                        <div class="kt-widget14__legend">
                          <span class="kt-widget14__bullet kt-bg-success"></span>
                          <span class="kt-widget14__stats">Accepted</span>
                        </div>
                        <div class="kt-widget14__legend">
                          <span class="kt-widget14__bullet kt-bg-warning"></span>
                          <span class="kt-widget14__stats">Cancel</span>
                        </div>
                        <div class="kt-widget14__legend">
                          <span class="kt-widget14__bullet kt-bg-brand"></span>
                          <span class="kt-widget14__stats">Pending</span>
                        </div>
                        <div class="kt-widget14__legend">
                          <span class="kt-widget14__bullet kt-bg-info"></span>
                          <span class="kt-widget14__stats">Scheduled</span>
                        </div>
                        <div class="kt-widget14__legend">
                          <span class="kt-widget14__bullet kt-bg-danger"></span>
                          <span class="kt-widget14__stats">Denied</span>
                        </div>
                      </div>
                  </div>
                </div>
